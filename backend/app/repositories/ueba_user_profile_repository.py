"""
SentinelAI - Database Domain Repository: UEBA_USER_PROFILE_REPOSITORY
"""
...
@dataclass
class UebaUserProfileRepositoryEntity:
    entity_id: str
    created_at: str
    data_payload: Dict[str, Any]

class UebaUserProfileRepository:
    def __init__(self):
...
ueba_user_profile_repository = UebaUserProfileRepository()
