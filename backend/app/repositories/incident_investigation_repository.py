"""
SentinelAI - Database Domain Repository: INCIDENT_INVESTIGATION_REPOSITORY
"""
...
@dataclass
class IncidentInvestigationRepositoryEntity:
    entity_id: str
    created_at: str
...
incident_investigation_repository = IncidentInvestigationRepository()
