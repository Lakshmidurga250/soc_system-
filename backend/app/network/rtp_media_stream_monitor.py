"""
SentinelAI - Enterprise Protocol Dissector: RTP_MEDIA_STREAM_MONITOR
"""
...
@dataclass
class RtpMediaStreamMonitorState:
    session_id: str
    source_ip: str
    destination_ip: str
    port: int
...
rtp_media_stream_monitor = RtpMediaStreamMonitor()
