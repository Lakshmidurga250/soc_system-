"""
SentinelAI - Enterprise Protocol Dissector: TFTP_PACKET_DISSECTOR
"""
...
@dataclass
class TftpPacketDissectorState:
    session_id: str
    source_ip: str
    destination_ip: str
    port: int
...
tftp_packet_dissector = TftpPacketDissector()
