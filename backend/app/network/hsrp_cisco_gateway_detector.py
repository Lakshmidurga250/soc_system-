"""
SentinelAI - Enterprise Protocol Dissector: HSRP_CISCO_GATEWAY_DETECTOR
"""
...
@dataclass
class HsrpCiscoGatewayDetectorState:
    session_id: str
    source_ip: str
    destination_ip: str
    port: int
...
hsrp_cisco_gateway_detector = HsrpCiscoGatewayDetector()
