...
const BASE_NAV_ITEMS = [
  ...
  { path: '/ueba', label: 'UEBA Behavioral', icon: '👤' },
  { path: '/itdr', label: 'ITDR Identity Threats', icon: '🔑' },
  { path: '/vulnerability', label: 'Vulnerabilities & CVSS', icon: '🎯' },
  { path: '/hunting', label: 'Threat Hunting', icon: '🏹' },
  { path: '/emulation', label: 'Adversary Emulation', icon: '⚔' },
  { path: '/compliance', label: 'Compliance Posture', icon: '📜' },
  { path: '/assistant', label: 'Local SOC Copilot', icon: '🤖' },
